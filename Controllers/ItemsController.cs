...
namespace OpenGameListWebApp.Controllers
{
    ...
    public class ItemsController : Controller
    {
        ...
        /// POST: api/items
        /// </summary>
        /// <returns>Creates a new Item and return itaccordingly.</ returns > [HttpPost()]
        public IActionResult Add([FromBody]ItemViewModel ivm)
        {
            if (ivm != null)
            {
                ...
                return new JsonResult(Mapper.Map<ItemViewModel>(item),
                DefaultJsonSettings);
            }
        ...
        public IActionResult Update(int id, [FromBody]ItemViewModel ivm)
        {
            if (ivm != null)
            {
                ...
                if (item != null)
                {
                    ...
                    return new
                    JsonResult(Mapper.Map<ItemViewModel>(item), DefaultJsonSettings);
                }
            }
